...
_ONTOLOGY_LIST: tuple[PredicateOntology, ...] = (
    ...
    _p(
        ...
        active=("vive en", "vivia en", "habita en", "reside en", "lives in"),
    ...
    _p(
        ...
        active=("mentor de", "maestro de", "maestra de", "entreno a", "mentor of"),
    ...
    _p(
        ...
        active=("sucedio a", "sucede a", "heredo de", "hereda", "heredar",
                "succeeded"),
