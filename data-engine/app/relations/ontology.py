...
_ONTOLOGY_LIST: tuple[PredicateOntology, ...] = (
    ...
    _p(
        ...
        active=("aliado con", "aliado de", "sello una alianza con", "allied with"),
        passive=("aliado con", "en alianza con"),
    ...
    _p(
        ...
        active=("enemigo de", "en guerra con", "rival de", "enemy of"),
    ...
    _p(
        ...
        passive=("hijo de", "hija de", "descendiente de"),
    ...
    _p(
        ...
        active=("mentor de", "maestro de", "entreno a", "mentor of"),
    ...
    _p(
        ...
        active=("sucedio a", "heredo de", "succeeded"),
    ...
    _p(
        ...
        active=("causo", "provoco", "desencadeno", "caused"),
    ...
    _p(
        ...
        passive=("guardado por", "custodiado por"),
        confusable=frozenset({"OWNS", "LOCATED_IN"}),
    ),
    _p(
        "ALIAS_OF", "identity", _ACTOR, _ACTOR,
        symmetric=True,
        active=("es alias de", "tambien conocido como", "alias of"),
