            ...
            doc.instructions.append(
                RollbackInstruction(
                    ...
                    detail={
                        ...
                        "workspace": view.workspace,
                        "label": op.node_label,
                        # INTEGRACION tanda 3: aqui chocaban R1 y R2. Gana la
                        # forma de R2 -- `op.partida_id` a secas -- porque es
                        # EXACTAMENTE lo que el executor estampo en el nodo
                        # (`executor.py`: `partida_id = view.partida_id`, y de
                        # ahi a `_estampar`). El `or view.partida_id` de R1 era
                        # equivalente en valor pero borraba la distincion que
                        # sostiene el fail-closed de R2: el campo AUSENTE no es
                        # el campo a `None`. `None` es la capa juego; la
                        # ausencia se deniega.
