# -*- coding: utf-8 -*-
"""INTEGRACION TANDA 6 -- el escenario completo por la RUTA DE OPERADOR.
...
def main():
    tmp = pathlib.Path(os.environ.get("ESCENARIO_TMP", "/tmp/escenario-tanda6b"))
    tmp.mkdir(parents=True, exist_ok=True)

    with neo4j_efimero_conexion("s9k-integracion6") as cx:
        driver = cx.driver
        op = Operador(cx, tmp)
