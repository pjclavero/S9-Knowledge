...
| **RK-19** | **P1** | **El repositorio es PÚBLICO y la documentación histórica publica la topología interna**: `192.168.1.152/.157/.204/.205`, `100.103.100.105` y puertos, en al menos una docena de ficheros de `docs/archivados/` y en la documentación consolidada | preexistente | `.env.example` ya usa marcadores (corregido 2026-08-09). Los documentos históricos **no** se han redactado: hacerlo en masa destruiría el valor probatorio de informes de auditoría. Decisión del operador: redactar, mover a privado, o aceptar | **ABIERTO** — requiere decisión, no una edición unilateral |
