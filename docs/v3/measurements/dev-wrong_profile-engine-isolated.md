...
- corrida: `dev-wrong_profile`
- subsistema declarado: `e2e`
- ablacion: `wrong_profile` — Perfil DELIBERADAMENTE incompleto ('bench-narrow'): faltan LEADS, RIVAL_OF y SIBLING_OF. Se espera abstencion o revision, no un predicado parecido inventado.
...
| Motor · decision (emparejadas) | 0.4286 |
| Motor · decision (gold entero) | 0.4286 |
| Motor · predicado F1 (emparejadas) | 0.5926 |
| Motor · predicado F1 (gold entero) | 0.5926 |
| Motor · direccion F1 (emparejadas) | 0.5926 |
| Motor · direccion F1 (gold entero) | 0.5926 |
...
| Motor · temporalidad | 0.0000 |
| Motor · aprobacion falsa | 0.1667 |
| Motor · rechazo falso | 0.5000 |
| Motor · abstencion | 0.0476 |
| E2E · hechos P | 1.0000 |
| E2E · hechos R | 0.3750 |
| E2E · hechos F1 | 0.5455 |
