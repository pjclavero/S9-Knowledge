...
- corrida: `dev-local_plus_external-chain`
- subsistema declarado: `e2e`
- ablacion: `local_plus_external` — Local y externo combinados.
- emparejamiento: span `exact`, umbral 0.5, clave de claim + []

| Métrica | Valor |
|---|---:|
| Extractor · menciones P | 0.4756 |
| Extractor · menciones R | 0.7647 |
| Extractor · menciones F1 | 0.5865 |
| Extractor · tipo (sobre emparejadas) | 0.9487 |
...
| Resolutor · exactitud de identidad | 0.7451 |
...
| Motor · predicado F1 (gold entero) | 0.0000 |
| Motor · direccion F1 (emparejadas) | n/d |
| Motor · direccion F1 (gold entero) | 0.0000 |
