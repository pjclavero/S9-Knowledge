...
- [38 · Primera ingesta controlada — preparación (Prioridad 3A)](38-first-controlled-ingest-report.md) — PREPARACIÓN sin escritura; fuente source_narrative_01; gate de autorización humana
- [39 · Autoaprobación basada en riesgo — modo sombra](39-risk-based-autoapproval-calibration.md) — análisis, NO ACTIVO
