...
| `POST /account/change-password` | si | si | si | si (9) | denegada | no-concluyente-csrf | require_authenticated_user | si |
...
| `POST /admin/partidas/grant` | si | si | si | si (9) | denegada | no-concluyente-csrf | require_admin, require_authenticated_user, grant_partida_access | si |
| `POST /admin/partidas/{access_id}/revoke` | si | si | si | si (1) | denegada | no-concluyente-csrf | require_admin, require_authenticated_user, revoke_partida_access | si |
...
| `POST /admin/users/new` | si | si | NO | NO (0) | denegada | no-concluyente-csrf | require_admin, require_authenticated_user | si |
| `GET /admin/users/{user_id}` | si | si | si | NO (0) | denegada | admin | require_admin, require_authenticated_user | si |
| `POST /admin/users/{user_id}` | si | si | NO | NO (0) | denegada | no-concluyente-csrf | require_admin, require_authenticated_user | si |
| `POST /admin/users/{user_id}/revoke-sessions` | si | si | si | NO (0) | denegada | no-concluyente-csrf | require_admin, require_authenticated_user | si |
| `POST /admin/users/{user_id}/unlock` | si | si | si | NO (0) | denegada | no-concluyente-csrf | require_admin, require_authenticated_user | si |
...
| `POST /partida/select` | si | si | si | si (31) | denegada | no-concluyente-csrf | require_authenticated_user | si |
...
| `POST /review-console/source/{source_id}/decide` | si | si | NO | si (7) | denegada | no-concluyente-csrf | _guard | si |
...
| `POST /v3/review/decide` | si | si | si | si (21) | denegada | no-concluyente-csrf | _guard | si |
| `GET /v3/review/glossary-candidates` | si | si | NO | NO (0) | denegada | reviewer | _guard | si |
| `POST /v3/review/undo` | si | si | si | NO (0) | denegada | no-concluyente-csrf | _guard | si |
