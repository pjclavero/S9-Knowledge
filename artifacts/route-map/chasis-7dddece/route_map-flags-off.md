...
| `GET /panel/entities` | si | si | NO | NO (0) | denegada | ninguno-sirve | _guard, slot_guard | NO |
| `GET /panel/entities/` | si | si | NO | NO (0) | denegada | ninguno-sirve | _guard, slot_guard | NO |
| `GET /panel/operations` | si | si | NO | NO (0) | denegada | ninguno-sirve | require_admin, require_authenticated_user, slot_guard | NO |
| `GET /panel/operations/` | si | si | NO | NO (0) | denegada | ninguno-sirve | require_admin, require_authenticated_user, slot_guard | NO |
| `GET /panel/review` | si | si | NO | NO (0) | denegada | ninguno-sirve | _guard, slot_guard | NO |
| `GET /panel/review/` | si | si | NO | NO (0) | denegada | ninguno-sirve | _guard, slot_guard | NO |
| `GET /panel/sources` | si | si | NO | NO (0) | denegada | ninguno-sirve | _guard, slot_guard | NO |
| `GET /panel/sources/` | si | si | NO | NO (0) | denegada | ninguno-sirve | _guard, slot_guard | NO |
...
### Rutas HUÉRFANAS (no alcanzables desde navegación): 36
- `GET /admin/health`
- `POST /admin/users/new`
- `POST /admin/users/{user_id}`
- `GET /api/admin/health`
