...
| `GET /api/graph` | si | si | si | si (13) | denegada | viewer | require_api_authenticated_user | si |
...
| `GET /panel/operations` | si | si | si | si (7) | denegada | admin | _guard, html_role_guard | si |
| `GET /panel/operations/` | si | si | NO | si (1) | denegada | admin | _guard, html_role_guard | si |
| `GET /panel/review` | si | si | si | si (7) | denegada | reviewer | _guard, html_role_guard | si |
